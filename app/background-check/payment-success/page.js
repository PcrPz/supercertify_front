  ...
  return (
    <div className="container max-w-5xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6 mt-2 ml-2">
        {paymentStatus === 'completed' ? 'ยืนยันการชำระเงินเรียบร้อย' : 'รอการตรวจสอบการชำระเงิน'}
      </h1>
      ...
      <div className="flex justify-end mt-8 space-x-4">
        ...
        <button 
          onClick={() => paymentStatus === 'completed' ? router.push(`/background-check/drop-document/${orderId}`) : router.push('/dashboard')}
