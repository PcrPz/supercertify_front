...
const CompletedContent = ({ order }) => {
  ...
  console.log("CompletedContent - Order Data:", order);
  ...
  // Check progress (100% for completed)
  const orderProgress = 100;
        ...
        <div className="bg-white rounded-[40px] border border-gray-200 overflow-hidden p-8">
          ...
          <div className="mb-10 bg-[#F5F7FF] p-6 rounded-lg border border-[#E0E4FF]">
            ...
            <p className="text-gray-600 text-sm">
              Background check completed ({orderProgress}%)
            </p>
          </div>
                    ...
                    {candidate.summaryResult ? (
                              ...
                              <div className="flex items-center mb-2">
                                ...
                                <h6 className="font-semibold text-gray-800 text-lg">
                                  ...
                                  <span className={
                                    ...
                                    candidate.summaryResult.overallStatus === 'fail' ? 'Fail' : 'Completed'}
                                  </span>
                                </h6>
                              </div>
                            </div>
                      ...
                      <div className="mt-6">
                        ...
                        <div className="p-4 bg-gray-50 rounded-lg text-center border border-gray-200">
                          ...
                          <p className="text-gray-500">Background check completed</p>
                        </div>
                      </div>
                    )}
                  </div>
          ...
          <div className="text-center p-6 bg-[#F5F7FF] rounded-lg border border-[#E0E4FF]">
            ...
            <h4 className="text-lg font-medium text-[#444DDA] mb-2">Background Check Completed</h4>
            <p className="text-gray-600">
              Your background check has been completed successfully. You can download the results above.
            </p>
